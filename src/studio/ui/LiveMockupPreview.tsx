...
function getArtworkStyle(placement: PlacementKey | undefined) {
  switch (placement) {
    case "LEFT_CHEST":
      return { left: "44%", top: "34%", width: "8%" };
    case "RIGHT_CHEST":
      return { left: "56%", top: "34%", width: "8%" };
    case "CENTER_FRONT":
      return { left: "50%", top: "40%", width: "18%" };
    case "FULL_FRONT":
      return { left: "50%", top: "42%", width: "30%" };
    case "CENTER_BACK":
      return { left: "50%", top: "40%", width: "18%" };
    case "FULL_BACK":
      return { left: "50%", top: "42%", width: "30%" };
    case "LEFT_SLEEVE":
      return { left: "31%", top: "37%", width: "7%" };
    case "RIGHT_SLEEVE":
      return { left: "69%", top: "37%", width: "7%" };
    default:
      return { left: "50%", top: "40%", width: "18%" };
  }
}
...
function TryOnPreview({
  ...
  const shouldTint =
    color === "CUSTOM" || (product === "OVERSIZED" && color === "BLACK");

  const tintColor =
    product === "OVERSIZED" && color === "BLACK" ? "#111111" : customHex;
  ...
  return (
    <section className="min-w-0 rounded-[26px] bg-[#faf8f6] p-4 shadow-[0_12px_40px_rgba(0,0,0,0.08)] sm:p-5">
        ...
        {shouldTint && (
          <div
            ...
            style={{
              ...
              opacity:
                product === "OVERSIZED" && color === "BLACK" ? 0.78 : 0.45,
              WebkitMaskImage: `url(${tryOnImage})`,
              maskImage: `url(${tryOnImage})`,
      ...
      <div className="mt-4 rounded-2xl bg-white p-3 text-xs leading-5 text-black/60">
        Upload artwork, choose placement, and it will appear on the garment.
      </div>
    </section>
  );
}
