...
export default function CheckoutModal({
  ...
  return (
    <div className="studio-modal-overlay">
      <div className="relative flex max-h-[calc(100dvh-48px)] w-[min(92vw,540px)] flex-col overflow-hidden rounded-[28px] bg-white text-black shadow-2xl">
        <button
          type="button"
          onClick={onClose}
          className="absolute right-5 top-4 z-10 flex h-9 w-9 items-center justify-center text-3xl leading-none text-black/40 hover:text-black"
          aria-label="Close checkout"
        >
          ×
        </button>
        <div className="studio-modal-scroll p-6 sm:p-8">
